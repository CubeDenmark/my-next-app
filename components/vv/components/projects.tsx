              ...
              <div className="flex gap-3">
                {project.demoLink ? (
                  <Link
                    ...
                    className="bg-accent text-accent-foreground px-4 py-2 rounded-lg text-sm font-medium hover:bg-accent/90 transition-colors duration-300"
                  >
                    View Demo
                  </Link>
                ) : (
                  <button
                    disabled
                    className="bg-gray-300 text-gray-500 px-4 py-2 rounded-lg text-sm font-medium cursor-not-allowed opacity-50"
                  >
                    View Demo
                  </button>
                )}
                ...
                {project.sourceLink ? (
                  <Link
                    ...
                    className="border border-accent text-accent px-4 py-2 rounded-lg text-sm font-medium hover:bg-accent hover:text-accent-foreground transition-all duration-300"
                  >
                    Source Code
                  </Link>
                ) : (
                  <button
                    disabled
                    className="border border-gray-300 text-gray-500 px-4 py-2 rounded-lg text-sm font-medium cursor-not-allowed opacity-50"
                  >
                    Source Code
                  </button>
                )}
